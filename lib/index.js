 ...
 *   @property {String} templateKey (optional)
...
function plugin(opts){
  ...
  var templateKey = opts.templateKey || "template";
  ...
  return function(files, metalsmith, done){
    ...
    function convert(file, done){
      ...
      if (inPlace) {
        ...
        str = metalsmith.path(dir, data[templateKey] || def);
